...
public class Quiz implements ActionListener{
	 ...
	 */
	private void sayWord(final ArrayList<String> wordAL) {
		if (wordAL != null & wordAL.size() > 0) {
			
			final double pace = _parent.getSpeed();
	...
	public void actionPerformed(ActionEvent e) {
		if (!isValidInput(e.getActionCommand())) {
			...
			if (!userWord.equals("") && !userWord.equals("\n") ) {
				_parent.appendPreviousInput("You entered:   "+ userWord + "\n");
